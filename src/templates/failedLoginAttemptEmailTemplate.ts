        ...
        <div class="content">
            ...
            <div class="security-notice">
                ...
                <div class="security-text">
                    ...
                    <div>You can safely ignore this message. Your account remains secure.</div>
                </div>
            </div>
            
            <div class="action-steps">
                <div class="action-title">⚠️ If this was not you, your account might be at risk. We recommend:</div>
            ...
            <div class="security-notice" style="background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); border-color: #3b82f6;">
                <div class="security-icon">🔐</div>
                <div class="security-text">
                    <div class="security-title" style="color: #1d4ed8;">Security Tip</div>
                    <div style="color: #1e40af;">Never share your password with anyone. We will never ask for your password via email or phone.</div>
                </div>
            </div>
        </div>
